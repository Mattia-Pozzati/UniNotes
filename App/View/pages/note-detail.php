...
<div class="container-fluid px-3 px-md-4 px-lg-5 py-4">
    ...
    <nav aria-label="breadcrumb" class="mb-4">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page"><?= htmlspecialchars($note['title'] ?? 'Nota') ?></li>
        </ol>
    </nav>
        ...
        <div class="col-lg-8">
            ...
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    <p class="card-text"><?= htmlspecialchars($note['description'] ?? 'Descrizione nota Abbastanza lunga') ?></p>
                    ...
                    <div class="d-flex justify-content-between align-items-center pt-3 border-top">
                        ...
                        <form action="/note/<?= $note['id'] ?>/like" method="POST" class="d-inline">
                            <button type="submit" class="btn btn-sm <?= $note['user_has_liked'] ?? false ? 'btn-primary' : 'btn-outline-primary' ?>">
                                ...
                                <div class="card mb-3">
                                    <div class="card-body">
                                        <div class="d-flex align-items-start mb-2">
                                            <i class="bi bi-person-circle me-2" style="font-size: 2rem; color: var(--bs-primary);"></i>
                                            <div class="flex-grow-1">
                                                ...
                                                <p class="mb-0 mt-2"><?= htmlspecialchars($comment['content'] ?? 'Descrizione nota Abbastanza lunga') ?></p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="d-flex align-items-start">
                                            <i class="bi bi-person-circle me-2" style="font-size: 1.5rem; color: var(--bs-secondary);"></i>
                                            <div>
                                                <strong class="small"><?= htmlspecialchars($reply['author']) ?></strong>
                                                <p class="mb-0 small text-muted"><?= htmlspecialchars($reply['content']) ?></p>
                                            </div>
                                        </div>
                                    </div>
                                <?php endforeach; ?>
